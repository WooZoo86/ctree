...
const CTSQL_MAX_FLDLEN=8192*10; // * 10 to prepare for the future.
var SQLBINARY = Struct({
  'tb_len': 'int',
  'tb_data': RefArray('uchar', CTSQL_MAX_FLDLEN)
  //'tb_data': 'uchar*'
});
var SQLBINARYPtr = ref.refType(SQLBINARY);
...
var ctsqlapi_function_list = {
  ...
  //'ctsqlGetParameterPrecisionX': ['int', ['pointer', 'int', ]],
  ...
  //'ctsqlSetParameterPrecisionX': ['int', ['pointer', 'int', 'int', ]],
  ...
  //'ctsqlGetColumnPrecisionX': ['int', ['pointer', 'int', ]],
...
ctsqlapi.SQLBINARY = SQLBINARY;
ctsqlapi.SQLBINARYPtr = SQLBINARYPtr;
