...
rem 12: Microsoft (R) C/C++ Optimizing Compiler Version 15.00.30729.01 for x64
	...
	echo "ADO.NET C# Sharp Tutorial not supported with Visual Studio 2008: .Net Tutorial Support begin from Visual Studio 2010 forward..."
	pause
rem	devenv CSharpTutorials.sln /rebuild debug
	goto OK_OK
	)
...
rem 14: Microsoft (R) C/C++ Optimizing Compiler Version 14.00.50727.762 for x64
	...
	echo "ADO.NET C# Sharp Tutorial not supported with Visual Studio 2005: .Net Tutorial Support begin from Visual Studio 2010 forward..."
	pause
rem	devenv CSharpTutorials.sln /rebuild debug
	goto OK_OK
	)
...
rem 15: Microsoft (R) 32-bit C/C++ Optimizing Compiler Version 12.00.8168 for 80x86
	...
	set myBLD=NO
	set myRUN=NO
	echo "ADO.NET  C# Sharp Tutorial not supported with Visual Studio 6: .Net Tutorial Support begin from Visual Studio 2010 forward..."
	pause
...
:subSDKLibVersion
pushd "Tutorial1"
copy /Y CSharpTutorials1.csproj CSharpTutorials1.csproj.bak
"%myUtil%" CSharpTutorials1.csproj
copy /Y temp.out CSharpTutorials1.csproj
del temp.out
popd

pushd "Tutorial2"
copy /Y CSharpTutorials2.csproj CSharpTutorials2.csproj.bak
"%myUtil%" CSharpTutorials2.csproj
copy /Y temp.out CSharpTutorials2.csproj
del temp.out
popd

pushd "Tutorial3"
copy /Y CSharpTutorials3.csproj CSharpTutorials3.csproj.bak
"%myUtil%" CSharpTutorials3.csproj
copy /Y temp.out CSharpTutorials3.csproj
del temp.out
popd

pushd "Tutorial4"
copy /Y CSharpTutorials4.csproj CSharpTutorials4.csproj.bak
"%myUtil%" CSharpTutorials4.csproj
copy /Y temp.out CSharpTutorials4.csproj
del temp.out
popd
