...
rem 12: Microsoft (R) C/C++ Optimizing Compiler Version 15.00.30729.01 for x64
	...
	set myBLD=NO
	set myRUN=NO
	echo "VB .Net Tutorial not supported with Visual Studio 2008: .Net Tutorial Support begin from Visual Studio 2010 forward..."
	pause
	goto OK_OK
	)
...
rem 14: Microsoft (R) C/C++ Optimizing Compiler Version 14.00.50727.762 for x64
	...
	set myBLD=NO
	set myRUN=NO
	echo "VB .Net Tutorial not supported with Visual Studio 2005: .Net Tutorial Support begin from Visual Studio 2010 forward..."
	pause
	goto OK_OK
	)
...
rem 15: Microsoft (R) 32-bit C/C++ Optimizing Compiler Version 12.00.8168 for 80x86
	...
	set myBLD=NO
	set myRUN=NO
	echo "VB .Net Tutorial not supported with Visual Studio 6: .Net Tutorial Support begin from Visual Studio 2010 forward..."
	pause
	goto OK_OK
	)
