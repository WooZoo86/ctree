...
rem 12: Microsoft (R) C/C++ Optimizing Compiler Version 15.00.30729.01 for x64
	...
	devenv DSQL_Tutorials.sln /rebuild debug
	goto OK_OK
	)
...
rem 15: Microsoft (R) 32-bit C/C++ Optimizing Compiler Version 12.00.8168 for 80x86
	...
	set myBLD=NO
	set myRUN=NO
	echo "DSQL Tutorial not supported with Visual Studio 6: .Net Tutorial Support begin from Visual Studio 2010 forward..."
	pause
...
rem ****************************
:subSDKLibVersion
pushd "DSQL_Tutorial1"
copy /Y DSQL_Tutorial1.vcxproj DSQL_Tutorial1.vcxproj.bak
"%myUtil%" DSQL_Tutorial1.vcxproj
copy /Y temp.out DSQL_Tutorial1.vcxproj
del temp.out
echo %CD%
popd

pushd "DSQL_Tutorial2"
copy /Y DSQL_Tutorial2.vcxproj DSQL_Tutorial2.vcxproj.bak
"%myUtil%" DSQL_Tutorial2.vcxproj
copy /Y temp.out DSQL_Tutorial2.vcxproj
del temp.out
popd

pushd "DSQL_Tutorial3"
copy /Y DSQL_Tutorial3.vcxproj DSQL_Tutorial3.vcxproj.bak
"%myUtil%" DSQL_Tutorial3.vcxproj
copy /Y temp.out DSQL_Tutorial3.vcxproj
del temp.out
popd

pushd "DSQL_Tutorial4"
copy /Y DSQL_Tutorial4.vcxproj DSQL_Tutorial4.vcxproj.bak
"%myUtil%" DSQL_Tutorial4.vcxproj
copy /Y temp.out DSQL_Tutorial4.vcxproj
del temp.out
popd
