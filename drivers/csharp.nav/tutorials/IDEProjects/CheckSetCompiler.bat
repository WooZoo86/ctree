...
rem 12: Microsoft (R) C/C++ Optimizing Compiler Version 15.00.30729.01 for x64
	...
	echo "C# Sharp Tutorial not supported with Visual Studio 2008: .Net Tutorial Support begin from Visual Studio 2010 forward..."
	pause
rem	devenv Tutorials.sln /rebuild debug
	goto OK_OK
	)
...
rem 14: Microsoft (R) C/C++ Optimizing Compiler Version 14.00.50727.762 for x64
	...
	echo "C# Sharp Tutorial not supported with Visual Studio 2005: .Net Tutorial Support begin from Visual Studio 2010 forward..."
	pause
rem	devenv Tutorials.sln /rebuild debug
	goto OK_OK
	)
...
rem 15: Microsoft (R) 32-bit C/C++ Optimizing Compiler Version 12.00.8168 for 80x86
	...
	set myBLD=NO
	set myRUN=NO
	echo "C# Sharp Tutorial not supported with Visual Studio 6: .Net Tutorial Support begin from Visual Studio 2010 forward..."
	pause
...
:subSDKLibVersion
pushd "Tutorial1"
copy /Y Tutorial1.csproj Tutorial1.csproj.bak
"%myUtil%" Tutorial1.csproj
copy /Y temp.out Tutorial1.csproj
del temp.out
popd

pushd "Tutorial2"
copy /Y Tutorial2.csproj Tutorial2.csproj.bak
"%myUtil%" Tutorial2.csproj
copy /Y temp.out Tutorial2.csproj
del temp.out
popd

pushd "Tutorial3"
copy /Y Tutorial3.csproj Tutorial3.csproj.bak
"%myUtil%" Tutorial3.csproj
copy /Y temp.out Tutorial3.csproj
del temp.out
popd

pushd "Tutorial4"
copy /Y Tutorial4.csproj Tutorial4.csproj.bak
"%myUtil%" Tutorial4.csproj
copy /Y temp.out Tutorial4.csproj
del temp.out
popd
