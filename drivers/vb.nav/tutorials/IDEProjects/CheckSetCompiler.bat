...
:subSDKLibVersion
pushd "Tutorial1"
copy /Y Tutorial1.vbproj Tutorial1.vbproj.bak
"%myUtil%" Tutorial1.vbproj
copy /Y temp.out Tutorial1.vbproj
del temp.out
popd

pushd "Tutorial2"
copy /Y Tutorial2.vbproj Tutorial2.vbproj.bak
"%myUtil%" Tutorial2.vbproj
copy /Y temp.out Tutorial2.vbproj
del temp.out
popd

pushd "Tutorial3"
copy /Y Tutorial3.vbproj Tutorial3.vbproj.bak
"%myUtil%" Tutorial3.vbproj
copy /Y temp.out Tutorial3.vbproj
del temp.out
popd

pushd "Tutorial4"
copy /Y Tutorial4.vbproj Tutorial4.vbproj.bak
"%myUtil%" Tutorial4.vbproj
copy /Y temp.out Tutorial4.vbproj
del temp.out
popd
