...
void Display_Records(void), Delete_Records(void);
...
void Update_CustomerMaster_Record(void)
{
   ...
   rc = ctsqlExecuteDirect(hCmd, "UPDATE custmast SET cm_custname = 'KEYON DOOLING' WHERE cm_custnumb = '1003'");
   if (rc != CTSQLRET_OK)
