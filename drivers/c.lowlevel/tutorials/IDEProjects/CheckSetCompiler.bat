...
rem ****************************
:subSDKLibVersion
pushd "LowLevelTutorial1"
copy /Y LowLevelTutorial1.vcxproj LowLevelTutorial1.vcxproj.bak
"%myUtil%" LowLevelTutorial1.vcxproj
copy /Y temp.out LowLevelTutorial1.vcxproj
del temp.out
popd
